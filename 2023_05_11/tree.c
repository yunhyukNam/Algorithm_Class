...
void preorderTraverse(TREENODE* _node);
void inorderTraverse(TREENODE* _node);
void postorderTraverse(TREENODE* _node);
...
void preorderTraverse(TREENODE* _node) {
    ...
    preorderTraverse(_node->left);
    preorderTraverse(_node->right);
}
...
void inorderTraverse(TREENODE* _node) {
    ...
    inorderTraverse(_node->left);
    printf("%c\n", _node->data);
    inorderTraverse(_node->right);
}
